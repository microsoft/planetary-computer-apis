...
from common.backoff import with_backoff
from tiler.config import get_settings
from tiler.errors import TilerError

STORAGE_ACCOUNT_PROP = "msft:storage_account"
CONTAINER_PROP = "msft:container"


class CollectionNotFoundError(TilerError):
...
class Collections:
    """Retrieves collections from the STAC API to use to determine
