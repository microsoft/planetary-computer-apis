...
def add_jrc_gsw() -> None:
    blues = cmap.get("blues")
    cmap_values = {0: [0, 0, 0, 0]}
    for i in range(1, 256):
        if i <= 100:
            cmap_values[i] = blues[int(i * 2.5)]
            cmap_values[i][-1] = int(i / 100 * 255)
        else:
            cmap_values[i] = [255, 255, 255, 0]

    custom_colormaps["jrc-gsw"] = cmap_values
