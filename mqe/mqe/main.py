...
from mqe.errors import MQE_DEFAULT_STATUS_CODES
from mqe.middleware import count_collection_requests, trace_request
from mqe.search import MQEItemCollectionUri, MQESearch, MQESearchGetRequest
...
api = PCStacApi(
    ...
    client=MQEClient.create(extra_conformance_classes=extra_conformance_classes),
    extensions=extensions,
    app=FastAPI(root_path=APP_ROOT_PATH, default_response_class=ORJSONResponse),
    search_request_model=MQESearch,
    search_get_request=MQESearchGetRequest,
    item_collection_uri=MQEItemCollectionUri,
    response_class=ORJSONResponse,
    exceptions={**DEFAULT_STATUS_CODES, **MQE_DEFAULT_STATUS_CODES},
)
